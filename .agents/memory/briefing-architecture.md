...
- **T2M** (`SCALES.temp`) : même traitement que PMER mais isothermes orange (`#e65c00`), couleur fixe (pas de dégradé par ligne — testé puis explicitement rejeté par l'utilisateur).
